...
class Typegoose {
    getModelForClass(t, { existingMongoose, schemaOptions, existingConnection, name, } = {}) {
        const modelName = name || this.constructor.name;
        if (!data_1.models[modelName]) {
        ...
        return data_1.models[modelName];
    }
    setModelForClass(t, { existingMongoose, schemaOptions, existingConnection, name, } = {}) {
        const modelName = name || this.constructor.name;
        ...
        data_1.models[modelName] = model(modelName, sch);
        data_1.constructors[modelName] = this.constructor;
        return data_1.models[modelName];
    }
